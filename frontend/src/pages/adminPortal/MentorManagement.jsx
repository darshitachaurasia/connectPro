        ...
        <tbody>
          {mentors.map((mentor) => (
            <tr key={mentor.$id} className="text-center">
              <td className="p-2 border-b border-blue-300">{mentor.name}</td>
              <td className="p-2 border-b border-blue-300">{mentor.status}</td>
              <td className="p-2 border-b border-blue-300">
